...
def main():
    ...
    if is_flash_attn_2_available() and model_args.use_flash_attn:
    ...
    if model_args.freeze_weights:
        logger.info("Freezing backpack weights and only training LM Head weights")
        for name, param in model.backpack.named_parameters():
